    ...
    <body>
        ...
        <article>
            <div id="form-container">
                ...
                <h1>Sign In</h1>
                <p>Sign In in order to receive all benefits! It's quick and easy</p>
                <?php
                    if (isset($credential_error)) {
                        echo "<p class='error'>Credentials are not valids</p>";
                    }
                ?>
                ...
                <a href="registration.php" id="outer-link">Don't have an account? Register!</a>
            </div>
        </article>
